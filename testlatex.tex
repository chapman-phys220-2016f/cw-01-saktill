...
%%% INSTRUCTOR COMMENTS %%%
% Probably you should change the problem number from x.yz
% Check out \lim for a roman font on your limit
% We will have much to say about the meaning of this definition
% when we get to numerical implementations of the derivative.
%%%%%%%%%%%%%%%%%%%%%%%%%%%
